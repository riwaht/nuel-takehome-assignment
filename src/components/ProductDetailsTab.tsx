  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-brand-grayLight dark:bg-brand-navy/60 p-4 rounded-lg border border-brand-grayMid/20 dark:border-brand-grayLight/15">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-brand-blue/10 to-brand-blue/20 dark:from-brand-blue/20 dark:to-brand-blue/30 rounded-xl border border-brand-blue/30 dark:border-brand-blue/50">
        ...
        <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-brand-gold/10 to-brand-gold/20 dark:from-brand-gold/20 dark:to-brand-gold/30 rounded-xl border border-brand-gold/30 dark:border-brand-gold/50">
          <div className="flex items-center">
        ...
        <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-brand-grayLight/50 to-brand-grayLight dark:from-brand-navy/60 dark:to-brand-navy/80 rounded-xl border border-brand-grayMid/30 dark:border-brand-grayLight/20">
          <div className="flex items-center">
